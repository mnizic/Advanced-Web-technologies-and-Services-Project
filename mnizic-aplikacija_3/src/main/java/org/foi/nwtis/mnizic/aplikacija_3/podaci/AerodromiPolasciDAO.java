...
public class AerodromiPolasciDAO {
	 ...
	 * 
	 */
	public List<AvionLeti> dajPolaskeAerodroma(PostavkeBazaPodataka konfig, String icao, String x, String vrijemeOd,
			String vrijemeDo) {
		...
		String upit = dohvatiUpitZaPolaskeAerodroma(icao, datumSekunde1, datumSekunde2);
		try {
	...
	/**
	 * Dohvati upit za polaske aerodroma.
	 *
	 * @param icao
	 * @param datum sekunde
	 * @param datum sekunde 
	 * @return upit
	 */
	private String dohvatiUpitZaPolaskeAerodroma(String icao, long datumSekunde1, long datumSekunde2) {
